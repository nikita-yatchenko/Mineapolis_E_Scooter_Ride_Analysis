...
scooter_data = pd.concat([sept_data, oct_data], join='outer')
scooter_data = scooter_data[scooter_data.EndCenterlineID.map(len) < 9]
...
scoot_group_daily['StartTimeH'] = scoot_group_daily.StartTime.str.split(' ', expand = True)[1]
...
ax.set_title('Hourly Average Number of E-Scooter Rides for September and October in Minneapolis, MN, USA', fontsize = 14)
